...
<Callout type="warn">
  **Important!** Starting from version 2.4.0, you MUST use modular imports. The main package (`azurajs`) only exports `AzuraClient`, `applyDecorators`, and basic types. Specific features like logger, validators, http-error, cors, etc. must be imported from their respective modules.
</Callout>
