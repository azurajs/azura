...
```typescript
import { parseCookiesHeader } from "azurajs";
...
```typescript
import { serializeCookie } from "azurajs";
...
```typescript
import { parseCookiesHeader, serializeCookie } from "azurajs";
import type { CookieOptions } from "azurajs";
