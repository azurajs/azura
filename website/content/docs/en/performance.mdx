...
- ✅ **Efficient routing** - Fast route matching algorithm
- ✅ **Minimal overhead** - Direct Node.js HTTP server integration
...
<Callout type="tip">
  ✅ **Paginate results** to limit transferred data
</Callout>
...
<Callout type="warn">
  ⚠️ **Avoid event loop blocking** with heavy synchronous operations
</Callout>

<Callout type="warn">
  ⚠️ **Don't do N+1 queries** - always use JOINs or batch queries
</Callout>
...
- [Cluster Mode](/docs/cluster-mode) - Scale across multiple cores
- [Rate Limiting](/docs/rate-limiting) - Protect against abuse
- [Examples](/docs/examples) - See optimized examples