---
title: Performance
description: Otimize sua aplicação AzuraJS para máximo desempenho
icon: Lightbulb
---
...
A maneira mais eficaz de melhorar o desempenho é usar cluster mode para utilizar todos os núcleos da CPU:
...
<Cards>
  ...
  <Card title="Exemplos" href="examples" description="Veja implementações completas" />
