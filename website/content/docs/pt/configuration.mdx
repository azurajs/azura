---
title: Configuração
description: Configure sua aplicação AzuraJS
icon: Settings
---
...
<Cards>
  <Card title="Controllers" href="controllers" description="Aprenda sobre padrões de controllers" />
  <Card title="Middleware" href="middleware" description="Adicione middleware personalizado" />
  <Card title="CORS" href="cors" description="Mergulhe fundo na configuração CORS" />
  <Card title="Rate Limiting" href="rate-limiting" description="Padrões avançados de rate limiting" />
</Cards>
