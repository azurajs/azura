---
title: Validação
description: Valide entrada de requisições com schemas e DTOs
icon: CircleCheck
---
...
```typescript
import { validateSchema } from "azurajs";
...
<Cards>
  ...
  <Card title="Error Handling" href="error-handling" description="Trate erros de validação" />
