...
<Callout type="info">
  O sistema Swagger do AzuraJS gera automaticamente documentação OpenAPI 3.0 a partir dos seus controllers e decorators, sem configuração manual.
</Callout>
...
<Cards>
  <Card title="Exemplos" href="/docs/examples">
    Veja exemplos completos de uso
  </Card>
  <Card title="Decorators" href="/docs/decorators">
    Aprenda mais sobre decorators
  </Card>
  <Card title="Controllers" href="/docs/controllers">
    Entenda como controllers funcionam
  </Card>
</Cards>
