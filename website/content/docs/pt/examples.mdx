...
import { Controller, Post, Get, Body, Headers, Res } from "azurajs";
...
```typescript
import { Controller, Post, Req, Res } from "azurajs";
...
import { LoggingMiddleware } from "azurajs";
...
<Cards>
  <Card title="GitHub" href="https://github.com/yourusername/azurajs" description="Contribua no GitHub" />
